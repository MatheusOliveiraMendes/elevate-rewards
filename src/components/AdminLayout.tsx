      ...
      >
        <div className="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
          <ul className="space-y-2">
            ...
            {/* ...demais itens do menu, igual ao seu HTML, convertidos para JSX... */}
            {/* Você pode colar o restante dos <li> aqui, convertendo class -> className */}
          </ul>
          {/* ...demais blocos do menu, convertidos para JSX... */}
        </div>
        {/* Rodapé do menu */}
